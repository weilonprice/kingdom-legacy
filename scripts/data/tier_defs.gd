...
const TIERS := [
	...
	},
	{
		...
		"unlocks": {
			"buildings": ["barracks", "scholars_hall", "stone_house", "chapel", "market", "iron_mine", "smithy", "trading_post",
				"garden", "fountain", "cobble_road", "brewery", "toolmaker", "sheep_farm", "weaver"],
	...
	},
	{
		...
		"unlocks": {
			"buildings": ["stone_tower", "warehouse", "tavern", "stone_wall", "wall_tower", "armory", "statue", "monument", "paved_road", "tailor", "vineyard", "winery"],
			"units": ["archer"],
